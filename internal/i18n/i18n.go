...
var catalog = map[string]map[Lang]string{
	...
	"ioc.hosts":    {RU: "Изменён файл hosts (перехват DNS)", EN: "Hosts file modified (DNS hijacking)"},
	"ioc.schtask":  {RU: "Создана запланированная задача (закрепление)", EN: "Scheduled task created (persistence)"},
